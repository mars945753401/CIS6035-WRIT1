  ...
  <div class="app-container">
          ...
          <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['system:role:edit']">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="handleDataScope" icon="el-icon-circle-check"
                v-hasPermi="['system:role:edit']">Data Scopes</el-dropdown-item>
              <el-dropdown-item command="handleAuthUser" icon="el-icon-user"
                v-hasPermi="['system:role:edit']">Allocate Users</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
      </el-table-column>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="Menu auths">
          ...
          <el-tree
            ...
            empty-text="Loading, please wait a while"
            :props="defaultProps"
          ></el-tree>
        </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="openDataScope" width="500px" append-to-body>
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="Data auths" v-show="form.dataScope == 2">
  ...
  methods: {
    ...
    handleDataScope(row) {
      ...
      getRole(row.roleId).then(response => {
        ...
        this.title = "Allocate Data Scope";
      });
    },
    /** 分配用户操作 */
