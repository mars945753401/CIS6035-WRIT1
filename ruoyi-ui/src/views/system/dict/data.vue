<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="Dictname" prop="dictType">
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Dictcode" align="center" prop="dictCode" />
      <el-table-column label="Dictlabel" align="center" prop="dictLabel">
        <template slot-scope="scope">
          <span v-if="(scope.row.listClass == '' || scope.row.listClass == 'default') && (scope.row.cssClass == '' || scope.row.cssClass == null)">{{ scope.row.dictLabel }}</span>
          <el-tag v-else :type="scope.row.listClass == 'primary' ? '' : scope.row.listClass" :class="scope.row.cssClass">{{ scope.row.dictLabel }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="Dictvalue" align="center" prop="dictValue" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="Dictlabel" prop="dictLabel">
          <el-input v-model="form.dictLabel" placeholder="Please input dict label" />
        </el-form-item>
        <el-form-item label="Dictvalue" prop="dictValue">
          <el-input v-model="form.dictValue" placeholder="Please input dict value" />
        </el-form-item>
        <el-form-item label="Cssclass" prop="cssClass">
          <el-input v-model="form.cssClass" placeholder="Please input css class" />
        </el-form-item>
