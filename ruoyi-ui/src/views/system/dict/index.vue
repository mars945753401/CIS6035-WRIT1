<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="DictID" align="center" prop="dictId" />
      <el-table-column label="Dictname" align="center" prop="dictName" :show-overflow-tooltip="true" />
      <el-table-column label="Dicttype" align="center" :show-overflow-tooltip="true">
...
export default {
  ...
  methods: {
    ...
    handleRefreshCache() {
      refreshCache().then(() => {
        this.$modal.msgSuccess("Refresh successfully!");
