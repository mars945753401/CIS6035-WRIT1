<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="menuName" label="Menuname" :show-overflow-tooltip="true" width="200"></el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="24" v-if="form.menuType != 'F'">
            <el-form-item label="Menu icon" prop="icon">
              ...
              >
                ...
                <el-input slot="reference" v-model="form.icon" placeholder="Please select menu icon" readonly>
                  <svg-icon
                    v-if="form.icon"
                    slot="prefix"
          ...
          <el-col :span="12">
            <el-form-item label="Menu name" prop="menuName">
              <el-input v-model="form.menuName" placeholder="Please input menu name" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item prop="path">
              ...
              <el-input v-model="form.path" placeholder="Please input route path" />
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="component">
              ...
              <el-input v-model="form.component" placeholder="Please input component path" />
            </el-form-item>
          </el-col>
