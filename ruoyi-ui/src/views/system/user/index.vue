  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="Phonenumber" align="center" key="phonenumber" prop="phonenumber" v-if="columns[4].visible" width="150" />
              ...
              <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['system:user:resetPwd', 'system:user:edit']">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item command="handleAuthRole" icon="el-icon-circle-check"
                    v-hasPermi="['system:user:edit']">Allocate roles</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
          </el-table-column>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="Usernickname" prop="nickName">
              <el-input v-model="form.nickName" placeholder="Please input usernickname" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="Phonenumber" prop="phonenumber">
              <el-input v-model="form.phonenumber" placeholder="Please input phonenumber" maxlength="11" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="Username" prop="userName">
              <el-input v-model="form.userName" placeholder="Please input username" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="Sex">
              <el-select v-model="form.sex" placeholder="Please select sex">
                <el-option
    ...
    <el-dialog :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
      ...
      >
        ...
        <div class="el-upload__text">Move file to here or <em>click to upload</em></div>
        <div class="el-upload__tip text-center" slot="tip">
          <div class="el-upload__tip" slot="tip">
            <el-checkbox v-model="upload.updateSupport" /> Update existed users?
          </div>
          <span>Only xls and xlsx file can be imported</span>
...
export default {
  ...
  methods: {
    ...
    /** 重置密码按钮操作 */
    handleResetPwd(row) {
      this.$prompt('Please input new password of ' + row.userName, "Hint", {
        ...
        inputValidator: (value) => {
          ...
          resetUserPwd(row.userId, value).then(response => {
            this.$modal.msgSuccess("Edit successfully, new password is: " + value);
          });
        }).catch(() => {});
    },
    /** 分配角色操作 */
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Confirm removing items of user ' + userIds + '?').then(function() {
        return delUser(userIds);
      }).then(() => {
        this.getList();
        this.$modal.msgSuccess("Remove successfully!");
      }).catch(() => {});
    },
    /** 导出按钮操作 */
    handleExport() {
